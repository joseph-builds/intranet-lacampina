...
export function ResourceDetailModal({
  ...
  const isExternalLink =
    ...
    (!resource.file_path && resource.resource_url);
          ...
          {resource.resource_type === "assignment" && (
            <>
              <div className="space-y-3">
                ...
                <div className="grid gap-4 text-sm">
                  {resource.assignment_deadline && (
                    <div className="flex items-center gap-2">
                      ...
                      <p className="font-medium">
                        {new Date(resource.assignment_deadline).toLocaleString(
                          "es-ES",
                          {
                            year: "numeric",
                            month: "long",
                ...
                {resource.teacher_files &&
                  resource.teacher_files.length > 0 && (
                    <div className="mt-4 space-y-2">
                      <p className="text-xs font-medium text-muted-foreground">
                        Archivos de instrucciones del profesor (
                        {resource.teacher_files.length})
                      </p>
