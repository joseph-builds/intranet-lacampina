  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (eventError) {
        ...
        toast.error(
          "Examen creado pero hubo un problema al crear el evento en el calendario",
        );
      }

      toast.success(
        "Examen creado exitosamente y agregado al calendario del curso",
      );
      onSuccess();
    } catch (error) {
              ...
              <Popover>
                <PopoverTrigger asChild>
                  ...
                  >
                    ...
                    {formData.start_time ? (
                      format(formData.start_time, "PPP p")
                    ) : (
                ...
                <PopoverContent className="w-auto p-0">
                  <Calendar
                    ...
                    onSelect={(date) => {
                      if (date) {
                        const newDate = formData.start_time
              ...
              <Card className="border-dashed">
                <CardContent className="text-center py-8">
                  <p className="text-muted-foreground">
                    No hay preguntas aún. Haz clic en "Agregar Pregunta" para
                    comenzar.
                  </p>
                </CardContent>
              </Card>
              ...
              <Card key={questionIndex}>
                ...
                <CardContent className="space-y-4">
                  ...
                  {question.question_type === "short_answer" && (
                    <div className="space-y-2">
                      <Label>
                        Respuesta esperada (opcional, para referencia del
                        profesor)
                      </Label>
                      <Input
                        value={question.correct_answer || ""}
                  ...
                  {question.question_type === "essay" && (
                    <div className="p-3 bg-muted rounded-md">
                      <p className="text-sm text-muted-foreground">
                        Las preguntas de ensayo se califican manualmente. Los
                        estudiantes tendrán un cuadro de texto para escribir su
                        respuesta.
                      </p>
                    </div>
                  )}
