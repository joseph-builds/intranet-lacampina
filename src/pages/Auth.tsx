  ...
  const handleResetPassword = async (e: React.FormEvent) => {
    ...
    try {
      ...
      toast({
        ...
        description: "Revisa tu bandeja de entrada. Hemos enviado un enlace de recuperación.",
      });
      
      // Pasamos a la pantalla de confirmación
          ...
          <>
            <CardHeader className="text-center pb-2">
              ...
              <CardDescription className="text-sm mt-2">
                Hemos enviado un enlace de recuperación a <strong>{resetData.email}</strong>
              </CardDescription>
            </CardHeader>
            <CardContent>
              <div className="flex flex-col gap-4 text-center">
                <div className="bg-blue-50 border border-blue-200 rounded-lg p-4">
                  <p className="text-sm text-blue-800 leading-relaxed">
                    📧 Revisa tu bandeja de entrada (o la carpeta de <strong>spam</strong>) y haz clic en el botón <strong>"Restablecer Contraseña"</strong> que está dentro del correo.
                  </p>
                </div>
                <p className="text-xs text-gray-400">El enlace expirará en 1 hora.</p>
                <Button
                  type="button"
                  variant="ghost"
